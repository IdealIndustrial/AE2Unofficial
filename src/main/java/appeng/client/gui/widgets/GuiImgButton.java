...
public class GuiImgButton extends GuiButton implements ITooltip
{
	...
	public GuiImgButton( final int x, final int y, final Enum idx, final Enum val )
	{
		...
		if( appearances == null )
		{
			...
			this.registerApp( 16 * 6, Settings.FUZZY_MODE, FuzzyMode.PERCENT_5, ButtonToolTips.FuzzyMode, ButtonToolTips.FZPercent_5 );
			this.registerApp( 16 * 6 + 1, Settings.FUZZY_MODE, FuzzyMode.PERCENT_25, ButtonToolTips.FuzzyMode, ButtonToolTips.FZPercent_25 );
			this.registerApp( 16 * 6 + 2, Settings.FUZZY_MODE, FuzzyMode.PERCENT_50, ButtonToolTips.FuzzyMode, ButtonToolTips.FZPercent_50 );
			this.registerApp( 16 * 6 + 3, Settings.FUZZY_MODE, FuzzyMode.PERCENT_75, ButtonToolTips.FuzzyMode, ButtonToolTips.FZPercent_75 );
			this.registerApp( 16 * 6 + 4, Settings.FUZZY_MODE, FuzzyMode.PERCENT_99, ButtonToolTips.FuzzyMode, ButtonToolTips.FZPercent_99 );
